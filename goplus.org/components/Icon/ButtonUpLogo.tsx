...
export default function ButtonUpLogo(props: SVGProps<SVGSVGElement>) {
    return (
        <svg width="18" height="18" fill="none" xmlns="http://www.w3.org/2000/svg" {...props} style={flipStyle}>
